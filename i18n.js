...
const TRANSLATIONS = {
  el: {
    ...
    'cal.next': '›',
    'cal.today': 'Σήμερα',
    'cal.noEvents': 'Τίποτα αυτή τη μέρα.',
    'cal.monthEmpty': 'Τίποτα αυτόν τον μήνα.',
    'cal.leaseStart': 'Έναρξη μίσθωσης',
    'cal.leaseEnd': 'Λήξη μίσθωσης',
    'cal.guestExpires': 'Λήγει κωδικός επισκέπτη',
    'cal.legend': 'Πάτα μια μέρα για λεπτομέρειες.',
    ...
    'pay.forTenancy': 'Μίσθωση',
    'pay.filterStatus': 'Κατάσταση',
    'pay.filterCategory': 'Κατηγορία',
    'pay.filterAll': 'Όλες',
    'pay.noneForFilter': 'Καμία χρέωση με αυτά τα φίλτρα.',
    'pay.notesRecurring': 'Σημείωση (προαιρετικό) — ίδια σε κάθε μήνα· ο μήνας μπαίνει μόνος του',
    'pay.tenancyOption': '{name} · {start} → {end}',
    'pay.showing': 'Χρεώσεις του ενοικιαστή: {name}',
    ...
    'maint.showing': 'Αναφορές του ενοικιαστή: {name}',
    'maint.filterStatus': 'Κατάσταση',
    'maint.filterPriority': 'Προτεραιότητα',
    'maint.noneForFilter': 'Καμία αναφορά με αυτά τα φίλτρα.',
    'maint.photos': 'Φωτογραφίες (προαιρετικό)',
    'maint.photosTooMany': 'Μέχρι 5 φωτογραφίες ανά αναφορά.',
    'maint.uploadingPhotos': 'Ανέβασμα φωτογραφιών...',
    'maint.deleteReport': 'Διαγραφή',
    'maint.deleteConfirm': 'Να διαγραφεί η αναφορά «{title}»;\n\nΘα διαγραφούν μαζί τα σχόλια και οι φωτογραφίες της. Δεν αναιρείται.',
    'maint.resolvedOn': 'Επιλύθηκε {date}',
  ...
  en: {
    ...
    'cal.monthEmpty': 'Nothing this month.',
    'cal.leaseStart': 'Lease starts',
    'cal.leaseEnd': 'Lease ends',
    'cal.guestExpires': 'Guest code expires',
    'cal.legend': 'Tap a day for details.',
    ...
    'pay.forTenancy': 'Tenancy',
    'pay.filterStatus': 'Status',
    'pay.filterCategory': 'Category',
    'pay.filterAll': 'All',
    'pay.noneForFilter': 'No charges match these filters.',
    'pay.notesRecurring': 'Note (optional) — same on every month; the month itself is added for you',
    'pay.tenancyOption': '{name} · {start} → {end}',
    'pay.showing': 'Charges for tenant: {name}',
    ...
    'maint.showing': 'Reports for tenant: {name}',
    'maint.filterStatus': 'Status',
    'maint.filterPriority': 'Priority',
    'maint.noneForFilter': 'No reports match these filters.',
    'maint.photos': 'Photos (optional)',
    'maint.photosTooMany': 'Up to 5 photos per report.',
    'maint.uploadingPhotos': 'Uploading photos...',
    'maint.deleteReport': 'Delete',
    'maint.deleteConfirm': 'Delete the report "{title}"?\n\nIts comments and photos go with it. This cannot be undone.',
    'maint.resolvedOn': 'Resolved {date}',
