...
const TRANSLATIONS = {
  el: {
    ...
    'login.invalidEmail': 'Το email δεν φαίνεται σωστό.',
    ...
    'onb.noAccessYet': 'Ο λογαριασμός σου δεν είναι ακόμα συνδεδεμένος με ακίνητο. Αν είσαι ο ενοικιαστής, βάλε τον κωδικό πρόσκλησης που σου έδωσε ο ιδιοκτήτης.',
    'onb.notApproved': 'Ο κωδικός είναι σωστός, αλλά ο λογαριασμός σου δεν έχει εγκριθεί ακόμα. Ζήτα από τον ιδιοκτήτη να προσθέσει το email σου.',
    ...
    'pay.attachFile': 'Λογαριασμός (PDF ή εικόνα, προαιρετικό)',
    ...
    'pay.attachment': 'Λογαριασμός (PDF ή εικόνα, προαιρετικό)',
    'pay.attachmentNote': 'Δεν επισυνάπτεται αρχείο σε επαναλαμβανόμενη σειρά.',
    'pay.openAttachment': 'Άνοιγμα λογαριασμού',
    ...
    'doc.scope': 'Ανήκει σε',
    'doc.scopeProperty': 'Το ακίνητο — μένει για πάντα',
    'doc.scopeTenancy': 'Τη μίσθωση — φεύγει μαζί της',
    'doc.propertyTitle': 'Έγγραφα ακινήτου',
    'doc.propertyHint': 'Οδηγίες συσκευών, κανονισμός, κάτοψη. Επιβιώνουν αλλαγής ενοικιαστή.',
    'doc.tenancyTitle': 'Έγγραφα μίσθωσης',
    'doc.tenancyHint': 'Συμβόλαιο, πρωτόκολλο παράδοσης. Διαγράφονται μαζί με τη μίσθωση.',
    'doc.propertyEmpty': 'Κανένα έγγραφο ακινήτου ακόμα.',
    ...
    'msg.showing': 'Συνομιλία με: {name}',
    'doc.showing': 'Έγγραφα μίσθωσης: {name}',
    'msg.blank': 'Γράψε κάτι πρώτα.',
    'info.edit': 'Επεξεργασία',
    'info.update': 'Ενημέρωση',
    'info.editing': 'Επεξεργασία: {title}',
    'info.cancelEdit': 'Ακύρωση',
    'info.moveUp': '↑',
    'info.moveDown': '↓',
    ...
    'pay.notesPlaceholder': 'π.χ. περιλαμβάνει και κοινόχρηστα',
    'pay.submit': 'Καταχώρηση',
    'pay.listTitle': 'Πληρωμές',
    'pay.groupCount': '{count} χρεώσεις',
    'pay.groupCountOne': '1 χρέωση',
    'pay.showUpcoming': 'Δείξε τις επόμενες χρεώσεις ({count})',
    'pay.showPrevious': 'Δείξε προηγούμενες χρεώσεις ({count})',
    'pay.payUrl': 'Σύνδεσμος πληρωμής (προαιρετικό)',
    'pay.payUrlPlaceholder': 'https://online.ndlgo.org.cy/...',
    'pay.payUrlInvalid': 'Ο σύνδεσμος πρέπει να ξεκινά με http:// ή https://',
    'pay.payNow': 'Πληρωμή ↗',
    'pay.declarePaid': 'Το πλήρωσα',
    'pay.undoDeclare': 'Αναίρεση',
    'pay.declaredPill': 'Δηλώθηκε',
    'pay.allCollected': 'Όλα εισπράχθηκαν.',
    'pay.removeBill': 'Αφαίρεση λογαριασμού',
    'pay.removeBillConfirm': 'Να αφαιρεθεί ο συνημμένος λογαριασμός; Το αρχείο διαγράφεται.',
    'pay.billRemoved': 'Ο λογαριασμός αφαιρέθηκε.',
    'pay.applyToSeries': 'Εφαρμογή και στους επόμενους μήνες της σειράς',
    'pay.delete': 'Διαγραφή',
    'pay.deleteConfirm': 'Να διαγραφεί η χρέωση; {what}',
    'pay.deleteSeries': 'Διαγραφή σειράς',
    'pay.deleteSeriesConfirm': 'Να διαγραφούν {count} ανεξόφλητες χρεώσεις αυτής της σειράς, από αυτήν και μετά;',
    'pay.seriesDeleted': 'Διαγράφηκαν {count} χρεώσεις.',
    'pay.seriesNothing': 'Δεν υπάρχουν ανεξόφλητες χρεώσεις για διαγραφή.',
    'pay.declaredOn': 'Δηλώθηκε: {date}',
    'pay.undoPaid': 'Αναίρεση πληρωμής',
    'pay.addReceipt': 'Ανέβασμα απόδειξης',
    'pay.openReceipt': 'Απόδειξη πληρωμής',
    'pay.noDueGroup': 'Χωρίς ημερομηνία',
    'photo.counter': '{index} από {total}',
    'photo.prev': 'Προηγούμενη φωτογραφία',
    'photo.next': 'Επόμενη φωτογραφία',
    'photo.close': 'Κλείσιμο',
    'maint.conversation': 'Συνομιλία',
    'maint.viewConversation': 'Άνοιγμα συνομιλίας',
    'maint.startConversation': 'Προσθήκη σχολίου',
    'maint.hideConversation': 'Απόκρυψη',
    'maint.commentCount': '{count} σχόλια',
    'maint.commentCountOne': '1 σχόλιο',
    'maint.noComments': 'Κανένα σχόλιο ακόμα.',
    'maint.showAllComments': 'Δείξε και τα {count}',
    'time.today': 'Σήμερα',
    'time.yesterday': 'Χθες',
    'msg.loadEarlier': 'Παλαιότερα μηνύματα',
    'list.showingCount': 'Εμφανίζονται {shown} από {total}',
    'list.loadMore': 'Φόρτωση περισσότερων',
    'pay.dueSoon': 'Άμεσα: {amount} ({count})',
    'pay.overdueCount': 'Ληξιπρόθεσμα: {amount} ({count})',
    'pay.nextDue': 'Επόμενη: {amount} · {date}',
    'pay.allSettled': 'Δεν οφείλεις τίποτα.',
    ...
    'tenant.leaseLine': 'Ενοίκιο {rent}/μήνα · Μίσθωση: {start} → {end}',
  ...
  en: {
    ...
    'login.invalidEmail': 'That email does not look right.',
    ...
    'onb.noAccessYet': 'Your account is not linked to a property yet. If you are the tenant, enter the invite code the owner gave you.',
    'onb.notApproved': 'The code is right, but your account has not been approved yet. Ask the owner to add your email.',
    ...
    'pay.attachFile': 'Bill (PDF or image, optional)',
    ...
    'pay.attachment': 'Bill (PDF or image, optional)',
    'pay.attachmentNote': 'A recurring series takes no attachment.',
    'pay.openAttachment': 'View bill',
    'pay.edit': 'Edit',
    ...
    'doc.scope': 'Belongs to',
    'doc.scopeProperty': 'The property — kept for good',
    'doc.scopeTenancy': 'The tenancy — removed with it',
    'doc.propertyTitle': 'Property documents',
    'doc.propertyHint': 'Appliance manuals, house rules, floor plan. They outlive a change of tenant.',
    'doc.tenancyTitle': 'Tenancy documents',
    'doc.tenancyHint': 'Contract, handover protocol. Deleted along with the tenancy.',
    'doc.propertyEmpty': 'No property documents yet.',
    ...
    'msg.showing': 'Conversation with: {name}',
    'doc.showing': 'Documents for tenancy: {name}',
    'msg.blank': 'Write something first.',
    'info.edit': 'Edit',
    'info.update': 'Update',
    'info.editing': 'Editing: {title}',
    'info.cancelEdit': 'Cancel',
    'info.moveUp': '↑',
    'info.moveDown': '↓',
    ...
    'pay.due': 'Due date',
    'pay.notes': 'Notes',
    'pay.notesPlaceholder': 'e.g. includes common charges',
    'pay.submit': 'Add entry',
    'pay.listTitle': 'Payments',
    'pay.groupCount': '{count} payments',
    'pay.groupCountOne': '1 payment',
    'pay.showUpcoming': 'Show more upcoming payments ({count})',
    'pay.showPrevious': 'Show previous payments ({count})',
    'pay.payUrl': 'Payment link (optional)',
    'pay.payUrlPlaceholder': 'https://online.ndlgo.org.cy/...',
    'pay.payUrlInvalid': 'The link must start with http:// or https://',
    'pay.payNow': 'Pay ↗',
    'pay.declarePaid': 'I have paid',
    'pay.undoDeclare': 'Undo',
    'pay.declaredPill': 'Marked paid',
    'pay.allCollected': 'Everything collected.',
    'pay.removeBill': 'Remove bill',
    'pay.removeBillConfirm': 'Remove the attached bill? The file is deleted.',
    'pay.billRemoved': 'Bill removed.',
    'pay.applyToSeries': 'Apply to the following months of this series too',
    'pay.delete': 'Delete',
    'pay.deleteConfirm': 'Delete this charge? {what}',
    'pay.deleteSeries': 'Delete series',
    'pay.deleteSeriesConfirm': 'Delete {count} unpaid charges in this series, from this one onward?',
    'pay.seriesDeleted': '{count} charges deleted.',
    'pay.seriesNothing': 'No unpaid charges left to delete.',
    'pay.declaredOn': 'Marked paid: {date}',
    'pay.undoPaid': 'Undo paid',
    'pay.addReceipt': 'Upload receipt',
    'pay.openReceipt': 'Payment receipt',
    'pay.noDueGroup': 'No due date',
    'photo.counter': '{index} of {total}',
    'photo.prev': 'Previous photo',
    'photo.next': 'Next photo',
    'photo.close': 'Close',
    'maint.conversation': 'Conversation',
    'maint.viewConversation': 'View conversation',
    'maint.startConversation': 'Add a comment',
    'maint.hideConversation': 'Hide',
    'maint.commentCount': '{count} comments',
    'maint.commentCountOne': '1 comment',
    'maint.noComments': 'No comments yet.',
    'maint.showAllComments': 'Show all {count}',
    'time.today': 'Today',
    'time.yesterday': 'Yesterday',
    'msg.loadEarlier': 'Load earlier messages',
    'list.showingCount': 'Showing {shown} of {total}',
    'list.loadMore': 'Load more',
    'pay.dueSoon': 'Due soon: {amount} ({count})',
    'pay.overdueCount': 'Overdue: {amount} ({count})',
    'pay.nextDue': 'Next due: {amount} · {date}',
    'pay.allSettled': 'Nothing outstanding.',
    ...
    'tenant.leaseLine': 'Rent {rent}/month · Lease: {start} → {end}',
