...
const TRANSLATIONS = {
  el: {
    ...
    'pay.notesRecurring': 'Σημείωση — μπαίνει αυτούσια σε ΚΑΘΕ μήνα, μην γράψεις συγκεκριμένο μήνα',
  ...
  en: {
    ...
    'pay.notesRecurring': 'Note — copied verbatim into EVERY month, so avoid naming one',
    'pay.tenancyOption': '{name} · {start} → {end}',
